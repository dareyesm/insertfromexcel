    ...
    public function upload_book($pathFile = false) {
        ...
        for($i=2;$i<=$rows;$i++){
            ...
            $sth->execute(array(
                ...
                ':title' => $objPHPExcel->getActiveSheet()->getCell('C'.$i)->getCalculatedValue(),
                ':autor' => $objPHPExcel->getActiveSheet()->getCell('D'.$i)->getCalculatedValue(),
                ':desc' => $objPHPExcel->getActiveSheet()->getCell('E'.$i)->getCalculatedValue(),
                ':edito' => $objPHPExcel->getActiveSheet()->getCell('F'.$i)->getCalculatedValue(),
                ':fecha' => $objPHPExcel->getActiveSheet()->getCell('G'.$i)->getCalculatedValue()
            ));
